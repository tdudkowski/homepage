...
description: "Najbardziej potrzebne pluginy: dostęp do plików, obrazki, SEO, itd."
---
...
Potem taki komponent importujemy do pliku strony, layoutu, czy szablonu i przekazujemy do niego propsy. Może wyglądac to tak:
...
Tutaj mamy dane strony i adres obrazka przesłany z frontmattera. Źródłem tych danych mogą być również propsy przesłane w komponeencie layoutu.
...
Pliku env oc do zasady nie wysyłamy na gihuba, ani inne publiczne miejsce. Musi zostać dodany do .gitignore. Wszyscy dostawcy usług online umożliwiają wpisanie tych parametrów na stronie podczas uploadu aplikacji.
